...
const Whitelist = ({error, whitelist}: WhitelistProps) => {
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        Api.whitelist.addToWhitelist(email).then(_ => {
            ...
            <div className={`card mainCard ${styles.addToWhitelistCard}`}>
                ...
                <form onSubmit={onSubmit}>
                    <table>
                            ...
                            <tr key={e}>
                                ...
                                <td align="center">
                                    <IconButton
                                        ...
                                        type="button"
                                        onClick={() => {
                                            let c = confirm("Are you sure you want to remove this email from the whitelist?");
                                            if (c) {
                                                Api.whitelist.removeFromWhitelist(e).then(_ => {
                                                    router.replace(router.asPath).then(_ => {
                                                    });
                                                }).catch(err => {
                        ...
                        <td align="center">
                            <IconButton type="submit" icon={faAdd} size="small" variant="opaque"/>
                        </td>
                        </tfoot>
                    </table>
                </form>
