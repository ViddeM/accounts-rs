        ...
        <CardLayout>
            <form className={`card mainCard`} onSubmit={onSubmit}>
                ...
                <div className={styles.createClientRow}>
                    <label htmlFor={CLIENT_NAME_ID}>
                        Client Name:
                    </label>
                    <TextField id={CLIENT_NAME_ID} name={CLIENT_NAME_ID} type="text" value={clientName} onChange={e => {
                        setClientName(e.target.value);
                    }}/>
                </div>
                <div className={styles.createClientRow}>
                    <label htmlFor={REDIRECT_URI_ID}>
                        Redirect Uri:
                    </label>
                    <TextField id={REDIRECT_URI_ID} name={REDIRECT_URI_ID} value={redirectUri} onChange={e => {
                ...
                <Button size="normal" variant="primary" className="marginTop" type="submit">
                    Create
                </Button>
            </form>
        </CardLayout>
